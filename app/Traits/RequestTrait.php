...
trait RequestTrait {
    public function makeAnAPICallToShopify($method, $endpoint, $url_params = null, $headers, $requestBody = null) {
        ...
        try {
            ...
            info('touch  ------ VerifyShopify middleware handle method makeAnAPICallToShopify endpoint --', [$endpoint]);
            info('touch  --------- VerifyShopify middleware handle method makeAnAPICallToShopify--',
            [[
